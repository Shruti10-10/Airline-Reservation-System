...
public class Login extends JFrame implements ActionListener
{
    ...
    Login()
    {
        ...
        l1=new JLabel();
        l1.setBounds(0,0,780,450);
        l1.setLayout(null);
        
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/air1.jpg"));
        Image i1 = img.getImage().getScaledInstance(780,450,Image.SCALE_SMOOTH);
