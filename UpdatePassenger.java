...
public class UpdatePassenger extends JFrame implements ActionListener
{
    ...
    UpdatePassenger()
    {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/air5.jpg"));
            ...
            public void mouseClicked(MouseEvent args0)
            {
                try
                {
                    ...
                    while(rest1.next())
                    {
                        ...
                        tf9.setText(rest1.getString("passsport"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                String q1="update passenger set name='"+name+"',age='"+age+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',nationality='"+nationality+"',gender='"+gender+"',passsport='"+passport+"' where username='"+username+"'";
                int aa=obj3.stm.executeUpdate(q1);
                if(aa==1)
                {
                    JOptionPane.showMessageDialog(null,"Your Date Successfully Updated.");
