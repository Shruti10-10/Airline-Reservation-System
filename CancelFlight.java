...
public class CancelFlight extends JFrame implements ActionListener
{
    ...
    CancelFlight()
    {
        ...
        try
        {
            ...
            String q="Select distinct tid from BookedFlights where status='success'";
       ...
       ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/air6.jpg"));
       ...
       ch1.addMouseListener(new MouseAdapter()
       {
           ...
           public void mouseClicked(MouseEvent arg0)
           {
               try
               {
                  ...
                  String q1="select * from BookedFlights where tid='"+tid+"'";
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                String q2="update BookedFlights set status='"+status+"' where tid='"+tid+"'";
