...
public class BookFlight extends JFrame implements ActionListener
{
    ...
    BookFlight()
    {
       ...
       // bt2.setForeground(new java .awt.Color(232,2,125));
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/air3.jpg"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                String q1="insert into BookedFlights values('"+tid+"','"+source+"','"+destination+"','"+classname+"','"+price+"','"+fcode+"','"+fname+"','"+jdate+"','"+jtime+"','"+username+"','"+name+"','"+status+"')";
