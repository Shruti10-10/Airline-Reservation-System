...
public class HomePage extends JFrame implements ActionListener
{
    ...
    HomePage()
    {
        ...
        ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/Aeroplane.jpg"));
       ...
       m1.setBackground(new java.awt.Color(1,1,1));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if(cmd.equals("View Cancled Ticket"))
        {
