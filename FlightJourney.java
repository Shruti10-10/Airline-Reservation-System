...
public class FlightJourney extends JFrame implements ActionListener
{
    ...
    FlightJourney()
    {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("AMS/icons/air9.jpg"));
        ...
        try
        {
            ...
            String q="Select distinct source from BookedFlights";
        ...
        {
            ConnectionClass obj=new ConnectionClass();
            String q="Select distinct destination from BookedFlights";
            ResultSet rest=obj.stm.executeQuery(q);
            while(rest.next())
            {
